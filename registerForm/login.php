...
if (isset($_POST['loginBtn'])) {
    ...
    $sql = "SELECT name, password FROM adminUser WHERE name = '$name' AND password = '$password'";
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-6">
                <form action="login.php" method="POST" class="mt-5 p-5 border bg-light">
                    <h4>Login</h4>
                    <br>
                    <?php
                    ...
                    if ($showAlert) {
                        ...
                        <strong>Success</strong>Now you Login in my webiste
                    ...
                    if ($exist) {
                        ...
                        Plz first register this username
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>';
                    }
                    if ($passwordErr) {
